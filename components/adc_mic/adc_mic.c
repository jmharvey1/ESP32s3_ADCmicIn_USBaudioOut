...
//jmh add
#define ADC_MIC_VER_MAJOR 0
#define ADC_MIC_VER_MINOR 0
#define ADC_MIC_VER_PATCH 0
...
const audio_codec_data_if_t *audio_codec_new_adc_data(audio_codec_adc_cfg_t *adc_cfg, adc_continuous_handle_t *ret_handle)
{
    //printf("JMH SAYs HELLO\n");
