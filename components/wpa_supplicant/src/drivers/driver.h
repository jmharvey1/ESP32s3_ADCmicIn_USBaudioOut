...
#include "../src/common/defs.h" //JMH ADDED
#include "../src/common/ieee802_11_defs.h" //JMH ADDED
#include "../src/common/wpa_common.h" //JMH ADDED
//#include "utils/list.h"
#include "../utils/list.h" //JMH ADDED
struct wpa_bss;
